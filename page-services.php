...
get_header(); ?>
	...
	<div class="mb-5 top-header-image cf">
    ...
    <div class="row-1 justify-content-center cf">
  ...
  <!-- 7th row -->
  <?php
  $rownew7_title    = get_field('rownew7_title');
  $rownew7_text     = get_field('rownew7_text');
  if($rownew7_title || $rownew7_text) { ?>
    <section id="newsection7" class="graysection cf">
      <div class="row justify-content-center">
        <div class="col-md-8 text-center">
          <?php if ($rownew7_title) { ?>
            <h1 class="cma-title-red fadeIn wow" data-wow-delay="0.5s"><?php echo $rownew7_title ?></h1>
          <?php }  ?>
          <?php if ($rownew7_text) { ?>
            <div class="text-normal fadeInUp wow" data-wow-delay="0.6s"><?php echo $rownew7_text ?></div>
          <?php } ?>
        </div>
      </div>
    </section>
  ...
  if($row_7_title || $row_7_text) { ?>
    <section id="proposalRow" class="temp-bottom text-center multicolored cf">
        <div class="wrapper">
          <?php if ($row_7_title) { ?>
            <h1 class="cma-title-white fadeInUp wow" data-wow-delay="0.5s"><?php echo $row_7_title ?></h1>
          <?php }  ?>
        
          <?php if ($row_7_text) { ?>
            <div class="text-white fadeInUp wow" data-wow-delay="0.6s"><?php echo $row_7_text ?></div>
          <?php } ?>
